...
public class AlgorithmUtility 
{
	...
	public boolean isAnagram(String str1, String str2) 
	{
		 ...
		 str2=str2.replaceAll("\\s",""); //remove the no of space from the string 
	 ...
	 * @param num input taken from the User
	...
	public AlgorithmUtility()  //constructor purpose
	{
	...
	/**
	 * Purpose: This method will calculate the EMI for the month on the basis of loan amount for particular year and it will be depend upon the rate of
	 ...
	 */
	public double LoanCalculate(int principalLoanAmount, int year, double rOI) 
	{
		...
		payment = (principalLoanAmount * rate) / (1 - Math.pow(1 + rate, -n));
		return payment;
	}
	 ...
	 */
	public double SqureRootUsingNewtonsMethod(int c) 
	{
		double t, epsilon;
		t = c;
