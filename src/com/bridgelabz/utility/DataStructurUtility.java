	...
	public T get(){
	 ...
	 Scanner scanner=new Scanner(System.in);
		...
		public void addAdPosition(String string) {
		    ...
		    /**
		     * purpose : this function used to delete last element in list
		     * 
		     */
		...
		{
			  Node Top=new Node(); //top element
			  Top.data=data;     //everytime assigning data to Top.data
			  if(top==null) 
			  {
				  top=Top;
		...
		/**
		 * purpose : Delete stack element from the list 
		 */
		public void pop() 
		{
			top=top.next;
			...
			{
				System.out.println("not elements is available : ");
			}
		}
		...
		public void addRear(T data) 
		{
			...
			else 
			{
				...
				rear.next=newNode; //added newly node at the end
				rear=newNode;      //newnode becomes rear
			}
			size++;
		}
