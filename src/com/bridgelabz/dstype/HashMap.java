/**
 * Purpose: Hash Map class implemented for hashmap functionality  
 */
...
public class HashMap<K, V> {
	...
	public HashMap() 
	{
		...
		arrCapacity = 10;            //capacity of the arraylist
		size = 0;
	...
	/**
	 * Purpose: Hash function is implemented for getting index hashed based on key 
	 * @param key key used is going to get hash code index
	 * @return it returns hash code index
	 */
	...
	public void add(K key, V value)
	{
		...
		HashNode<K, V> head = arrList.get(hashIndex); // Get head of chain
